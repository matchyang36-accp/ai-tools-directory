...
export const tools: Tool[] = [
  // ---- Copywriting ----
  {
    ...
    description:
      "Jasper is an AI marketing platform with brand context, agents and content pipelines for campaign production. Generated assets require editorial review.",
    pricing: "Check official plans and pricing",
    rating: 4.6,
    pros: ["Brand context", "Marketing workflows", "Shared reference material"],
    cons: ["Brand context needs maintenance", "Workflow setup takes time"],
  ...
  },
  {
    ...
    pricing: "Check official plans and pricing",
    rating: 4.4,
    pros: ["Connected workflow actions", "Brand Voice and Infobase", "Teamspaces"],
    cons: ["Outputs need review", "Workflows need setup and maintenance"],
  ...
  },
  {
    ...
    name: "Writesonic",
    category: "copywriting",
    tagline: "AI article drafting and content workflows",
    description:
      "Writesonic offers an AI article workflow with tone, citation and internal-link options. Writers must verify sources and edit drafts before publication.",
    pricing: "Check official plans and pricing",
    rating: 4.3,
    pros: ["Article workflow", "Citation options", "Internal-link options"],
    cons: ["Sources need verification", "Access varies by plan"],
    website: "https://writesonic.com",
    bestFor: "Content teams with an editorial review process",
  },
  {
    slug: "rytr",
    name: "Rytr",
  ...
  // ---- SEO ----
  {
    ...
    name: "Surfer SEO",
    category: "seo",
    tagline: "Search-content optimization workflow",
    description:
      "Surfer combines Content Editor guidance, page auditing, internal-link suggestions and content monitoring for search-focused workflows.",
    pricing: "From $49/mo billed yearly (Sep 2026)",
    rating: 4.8,
    pros: ["Guided content workflow", "Page auditing", "Internal-link suggestions"],
    cons: ["Human review still required", "Plan limits vary"],
    website: "https://surferseo.com",
    featured: true,
    bestFor: "Teams creating and refreshing search content",
  },
  {
    slug: "clearscope",
    name: "Clearscope",
    category: "seo",
    tagline: "Content optimization and monitoring",
    description:
      "Clearscope combines research-led Drafts, editorial integrations and Content Inventory monitoring for content teams.",
    pricing: "From $129/mo (Sep 2026)",
    rating: 4.5,
    pros: ["Research-led Drafts", "Editorial integrations", "Content Inventory"],
    cons: ["Human review still required", "Usage allowances vary"],
    website: "https://www.clearscope.io",
    bestFor: "Content teams with editorial and refresh workflows",
  },
  {
    slug: "frase",
    name: "Frase",
  ...
  },
  {
    ...
    name: "Metricool",
    category: "social-media",
    tagline: "Social planning, analytics and reporting",
    description:
      "Metricool combines social planning, publishing, analytics, reporting and inbox workflows, with feature access varying by network and plan.",
    pricing: "Check current pricing",
    rating: 0,
    pros: ["Planning and analytics workspace", "Reporting workflows", "Inbox and integration options"],
    cons: ["Network capabilities vary", "Plan and brand limits apply"],
    website: "https://metricool.com",
    bestFor: "Social teams and agencies managing repeatable planning and reporting",
  },
  {
    slug: "postplanner",
    name: "Post Planner",
  ...
  },
  {
    ...
    name: "Instantly",
    category: "email-outreach",
    tagline: "Email-first outbound workflow",
    description:
      "Instantly combines cold email campaigns, sending-account management, lead sourcing, a centralized reply inbox and CRM-oriented workflows.",
    pricing: "Check current pricing",
    rating: 0,
    pros: ["Email campaign controls", "Lead sourcing workflow", "Centralized replies"],
    cons: ["Module limits vary", "Channel support needs verification"],
    website: "https://instantly.ai",
    bestFor: "Email-first outbound teams evaluating an integrated workflow",
  },
  {
    slug: "lemlist",
    name: "Lemlist",
    category: "email-outreach",
    tagline: "Personalized multichannel outreach",
    description:
      "Lemlist combines email outreach with supported LinkedIn, calling and other multichannel steps, plus lead data, deliverability and inbox workflows.",
    pricing: "Check current pricing",
    rating: 0,
    pros: ["Multichannel sequences", "Personalization controls", "Centralized conversations"],
    cons: ["Channel access varies", "Workflow setup needs review"],
    website: "https://www.lemlist.com",
    bestFor: "Teams coordinating personalized multichannel outreach",
  },
  ...
  },
  {
    ...
    name: "Midjourney",
    category: "image-design",
    tagline: "Visual exploration and style development",
    description:
      "Midjourney is a generative image platform for exploring visual directions with prompts, image references, personalization, moodboards and web-based editing.",
    pricing: "Check current pricing",
    rating: 0,
    pros: ["Visual exploration", "Reference workflows", "Web editor"],
    cons: ["Generated details need review", "Privacy access varies"],
    website: "https://www.midjourney.com",
    bestFor: "Visual concepts, moodboards and campaign ideation",
  },
  {
    slug: "leonardo-ai",
    name: "Leonardo.Ai",
    category: "image-design",
    tagline: "Reference-guided image creation and editing",
    description:
      "Leonardo.Ai combines image generation, reference guidance and editing tools for developing and refining creative assets.",
    pricing: "Check current pricing",
    rating: 0,
    pros: ["Reference guidance", "Inline and canvas editing", "Preset workflows"],
    cons: ["Generated details need review", "Token costs vary by task"],
    website: "https://leonardo.ai",
    bestFor: "Reference-led image concepts and iterative asset workflows",
  },
  {
    slug: "adobe-firefly",
    name: "Adobe Firefly",
    category: "image-design",
    tagline: "Generative creation and editing in Adobe workflows",
    description:
      "Adobe Firefly combines Adobe-developed and partner generative models across image creation, targeted editing and supported Adobe app workflows.",
    pricing: "Check current pricing",
    rating: 0,
    pros: ["Generative editing", "Adobe app workflows", "Model choice"],
    cons: ["Model terms vary", "Generated details need review"],
    website: "https://www.adobe.com/products/firefly.html",
    bestFor: "Adobe users exploring and refining creative image assets",
  },
  {
    slug: "looka",
    name: "Looka",
  ...
  },
  {
    ...
    name: "Reclaim",
    category: "productivity",
    tagline: "AI calendar planning and time protection",
    description:
      "Reclaim is an AI calendar assistant for protecting focus time, managing recurring routines and adapting plans as priorities change.",
    pricing: "Free and paid plans (verify current pricing)",
    rating: 4.1,
    pros: ["Adaptive planning", "Focus and routines", "Calendar and task integrations"],
    cons: ["Setup needs clear rules", "Behavior varies by version"],
    website: "https://reclaim.ai",
    bestFor: "Knowledge workers with dynamic calendars",
  },
  {
    slug: "taskade",
    name: "Taskade",
